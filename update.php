...
<body>
    ...
    <div class="container" id="" style=" 'display: block;' ">
        <div class="col-sm-9">
            ...
            <form action="editar.php" method="POST">
            <?php echo "<h2> Importe a Modificar de Id Tarjeta: ' $tarjeta '</h2> "?>
    ...
    FROM mtConsumoGasolinaPrueba g
...
/*SELECT g.id_equipo_transporte,g.consumo_no_ticket,g.consumo_saldo_anterior,g.consumo_importe,g.consumo_saldo_actual,g.id_consumo,mt.tar_saldo_actual
FROM mtConsumoGasolinaPrueba g
    inner join mtTarjetaPrueba as mt
    on g.id_equipo_transporte=mt.id_equipo_transporte
    where g.id_consumo >'370129'
and g.id_equipo_transporte = '2313'
    GROUP BY g.id_consumo;*/
    ...
    ?>
        ...
        <div class="container" id="" style=" 'display: block;' ">
            <div class="col-sm-9">
                <table class="table">
                <?php echo "<h2> Consumos Posteriores de Id Tarjeta: ' $tarjeta '</h2> "?>
                    <thead >
                        <tr>
                            <th class="posterior">Id Consumo </th>
                            <th class="posterior">Consumo saldo anterior </th>
            ...
            Array.from(contenido).forEach((element,index) => {
                ...
                // Almacenar el valor en el array según la posición
                 ...
                 valoresPorPosicion2[index] = consumoAnteriorActualizado;
                    ...
                    //const ultimoElemento = nombres[nombres.length - 1]
              ...
              const ultimoElemento = valoresPorPosicion[valoresPorPosicion.length- 1];  
              console.log(ultimoElemento);
              document.getElementById('ultimoValorInput').value = ultimoElemento;
                }else{
