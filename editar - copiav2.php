...
$i=0;
   ...
   // echo "Registro actualizado correctamente en mtConsumoGasolinaPrueba para id_consumo: $consumos<br><br>";
        ...
        echo "datos vienen vacios";
    } 
}
    $i=0;  
    foreach ($_POST['id_equipo_transporte'] as $equipo) { 
        
       $saldo_actual_tarjeta=$_POST['ultimoValor'][0]; //posicion 0 para obtener el valor que pasamos y mandar a la base.
       $equipo_transporte=$_POST['id_equipo_transporte'][$i]; //Id de equipo de transporte para pasar y actualizar.
